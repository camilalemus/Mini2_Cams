...
uint8_t BMP280_Read8(uint8_t reg_addr)
{
  ...
  I2C_Master_Start();
  I2C_Master_Write( BMP280_I2C_ADDRESS); //EE escritura
  I2C_Master_Write(reg_addr);
  I2C_Master_Start();
  I2C_Master_Write( BMP280_I2C_ADDRESS | 1); //EF lectura
...
uint16_t BMP280_Read16(uint8_t reg_addr)
{
  ...
  I2C_Master_Start();
  I2C_Master_Write( BMP280_I2C_ADDRESS);
  I2C_Master_Write(reg_addr);       //envio la direccion a donde quiero que vaya
  I2C_Master_Start();
